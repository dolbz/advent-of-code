...
# This is done ahead of time by multiplying the divisors in the input.
# It could be calculated quickly after the file is parsed so it works for other inputs
COMMON_MULTIPLE = 9_699_690
...
class Operation:
    ...
    def perform(self, old_value):
        ...
        if output >= COMMON_MULTIPLE:
            remainder = output % COMMON_MULTIPLE
            output = COMMON_MULTIPLE + remainder
        return output
